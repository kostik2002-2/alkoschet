...
// ==========================================================
const articleHeroes = {
  traditions: { src: 'img/001.png', alt: 'Роскошная свадебная сервировка с розами, свечами и хрустальными бокалами' },
  a20: { src: 'img/002.png', alt: 'Зимний свадебный стол в уютном деревянном доме на севере России' },
  a50: { src: 'img/003.png', alt: 'Классическая светлая свадебная сервировка в элегантном банкетном зале' },
  a100: { src: 'img/004.png', alt: 'Южная свадебная сервировка на террасе у моря на закате' },
  faq: { src: 'img/005.png', alt: 'Современная свадебная сервировка с цветами, свечами и башней из бокалов' }
};
...
const galleryData = {
  traditions: [
    { src: 'img/006.png', alt: 'Хрустальные бокалы и свечи на свадебном столе', cap: 'Хрусталь и свечи' },
    { src: 'img/007.png', alt: 'Традиционный свадебный каравай на вышитом рушнике', cap: 'Каравай' },
    { src: 'img/008.png', alt: 'Вышитый свадебный текстиль и праздничная сервировка', cap: 'Вышивка и традиции' }
  ],
  a20: [
    { src: 'img/009.png', alt: 'Зимняя северная сервировка у окна со снегом', cap: 'Северная традиция' },
    { src: 'img/010.png', alt: 'Официант разливает шампанское в башню из бокалов', cap: 'Игристое' },
    { src: 'img/011.png', alt: 'Руки гостей поднимают хрустальные бокалы для свадебного тоста', cap: 'Свадебный тост' }
  ],
  a50: [
    { src: 'img/012.png', alt: 'Роскошная цветочная композиция на свадебном столе', cap: 'Цветочная композиция' },
    { src: 'img/013.png', alt: 'Премиальная свадебная сервировка с фарфором и золотыми приборами', cap: 'Премиальная сервировка' },
    { src: 'img/014.png', alt: 'Свадебный десертный стол с тортом, макаронами и свечами', cap: 'Десертный стол' }
  ],
  a100: [
    { src: 'img/015.png', alt: 'Современная минималистичная свадебная сервировка', cap: 'Современный стиль' },
    { src: 'img/016.png', alt: 'Исторический банкетный зал с люстрами и свадебными столами', cap: 'Исторический зал' },
    { src: 'img/017.png', alt: 'Тихий свадебный зал после праздника со свечами и цветами', cap: 'После праздника' }
  ],
  faq: [
    { src: 'img/018.png', alt: 'Южная свадебная сервировка у моря с цитрусами и цветами', cap: 'Южное застолье' },
    { src: 'img/019.png', alt: 'Летняя веранда со свадебным столом, свечами и блюдами', cap: 'Летняя веранда' },
    { src: 'img/020.png', alt: 'Подарок гостю и именная карточка на свадебной сервировке', cap: 'Подарки гостям' }
  ]
};
...
function route(name) {
  ...
  setTimeout(() => {
    ...
    if (heroImg) { heroImg.src = hero.src; heroImg.alt = hero.alt; }
